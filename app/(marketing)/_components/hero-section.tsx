...
import HeroLight from '@/public/screenshot_2_light.png';
import HeroDark from '@/public/screenshot_1_dark.png';
import ArcjetLogo from '@/public/companies/archjet.png';
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                <TextEffect
                                    ...
                                    Glide organizes conversations into channels with threads, is realtime, and uses AI to keep teams in sync.
                                </TextEffect>
