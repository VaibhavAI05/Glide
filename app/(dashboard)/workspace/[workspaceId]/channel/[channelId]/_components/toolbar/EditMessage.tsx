import { updateMessageSchema, updateMessageSchemType } from "@/app/schemas/message"
...
export function EditMessage({message, onCancel, onSave}: EditMessageProps) {
    ...
    function onSubmit(data: updateMessageSchemType) {
                        ...
                        <FormControl>
                            <RichTextEditor field={field} sendButton={
                                <div className="flex items-center gap-4">
                                    <Button onClick={onCancel} type="button" size="sm" variant="outline" disabled={updateMutation.isPending}>Cancel</Button>
