...
// type Env = Cloudflare.Env & Record<string, unknown>
...
export class Chat extends Server {
  ...
  onConnect(connection: Connection) {
    ...
    //send presence to newly connected user
    ...
    try {
      ...
      if(presence.success) {
        if(presence.data.type === 'add-user') {
          ...
          //Broadcast update presence to all clients
          this.updateUsers()
          return
        }
  ...
  updateUsers() {
    ...
    //Use PartyServer's built-in broadcasr method
